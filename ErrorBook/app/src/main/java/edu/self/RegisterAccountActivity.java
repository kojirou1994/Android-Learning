				...
				new Thread(){
					public void run() {
						try {
							...
							userObject.put("userId", etuserId.getText().toString().trim() );
							userObject.put("userName", etuserName.getText().toString().trim() );
							userObject.put("password", etpassword.getText().toString().trim() );
							userObject.put("phone",   etphone.getText().toString().trim() );
							userObject.put("address", etaddress.getText().toString().trim() ); 
